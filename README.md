# E2E simulator tests.
metadrive simulator for end to end model test.

![E2E closeloop test](./e2e_metadrive_test/output.gif)
...
## drl demo scripts
    python ppo_tiny.py
![Alt text](./drl_control/saved_images/season_reward.png)
![Alt text](./drl_control/saved_images/test0.png)

## flow match demo scripts
    python flow_match_tiny.py
![Alt text](./drl_control/saved_images/flow_match_test.png)